...
import { createLandListing, deleteLandListing, getLandListingBySlug, getLandListingList, updateLandListing } from "./land-listing.service.js";
...
export async function listLandListings(request, response) {
...
export async function getLandListingDetail(request, response) {
...
export async function createLandListingHandler(request, response) {
    try {
...
export async function updateLandListingHandler(request, response) {
    try {
        const input = landListingBodySchema.parse(request.body);
...
export async function deleteLandListingHandler(request, response) {
