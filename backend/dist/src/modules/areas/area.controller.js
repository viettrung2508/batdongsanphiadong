...
export async function listAreas(_request, response) {
    const items = await getAreaList();
    response.json({
        items
    });
}
export async function createAreaHandler(request, response) {
    try {
...
export async function updateAreaHandler(request, response) {
    try {
        const input = areaBodySchema.parse(request.body);
...
export async function deleteAreaHandler(request, response) {
    try {
