...
export async function listApartments(request, response) {
...
export async function getApartmentDetail(request, response) {
...
export async function createApartmentHandler(request, response) {
    try {
...
export async function updateApartmentHandler(request, response) {
    try {
        const input = apartmentBodySchema.parse(request.body);
...
export async function deleteApartmentHandler(request, response) {
