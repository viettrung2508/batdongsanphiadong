...
exports.landListingBodySchema = exports.listLandListingsQuerySchema = void 0;
const client_1 = require("@prisma/client");
const zod_1 = require("zod");
const listSortSchema = zod_1.z.enum(["latest", "price_desc", "price_asc"]);
exports.listLandListingsQuerySchema = zod_1.z.object({
...
exports.landListingBodySchema = zod_1.z.object({
    name: zod_1.z.string().min(1),
    slug: zod_1.z.string().min(1),
    areaSlug: zod_1.z.string().min(1),
    address: zod_1.z.string().min(1),
    acreage: zod_1.z.string().optional(),
