...
function handlePostError(error: unknown, response: Response) {
...
export async function getPostDetail(request: Request, response: Response) {
...
export async function createPostHandler(request: Request, response: Response) {
  try {
